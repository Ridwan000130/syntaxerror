...
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$below Premium Script by Ridz07"
echo -e   "  \e[$below Original Source By Vcode Remodded BY NiLphreakz "
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   ""
...
;;
4)
clear;wget -q https://raw.githubusercontent.com/Ridz07/noobzvpns/main/m-noobz && chmod +x m-noobz && ./m-noobz
;;
5)
system
;;
